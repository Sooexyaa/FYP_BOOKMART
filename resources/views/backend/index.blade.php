...
@section('title','BOOKMART|| DASHBOARD')
        ...
        <div class="card border-left-primary shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Genre</div>
...
<script type="text/javascript">
  ...
  function drawChart()
  {
    ...
    pieSliceText: 'value', // Display absolute values instead of percentages
    tooltip: { // Customize tooltips
        showColorCode: true, // Display color codes
        text: 'value' // Display absolute values instead of percentages
    }
};
