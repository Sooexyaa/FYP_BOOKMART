<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="categoryCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('category.index')}}">Genre</a>
            <a class="collapse-item" href="{{route('category.create')}}">Add Genre</a>
          </div>
        </div>
    </li>
    {{-- Products --}}
    ...
    <li class="nav-item">
        ...
        <div id="brandCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Publication Options:</h6>
            <a class="collapse-item" href="{{route('brand.index')}}">Publications</a>
            <a class="collapse-item" href="{{route('brand.create')}}">Add Publication</a>
          </div>
        </div>
    </li>
    ...
    {{-- <li class="nav-item">
        ...
        <div id="shippingCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('shipping.index')}}">Delivery</a>
